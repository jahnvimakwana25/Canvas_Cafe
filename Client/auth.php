                ...
                <div class="col-lg-9">
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <div class="navbar-nav mr-auto py-0">
                                <span class="nav-item nav-link active" id="customer_name" style="display:none"></span>
                                <a href="logout.php" class="nav-item nav-link" id="logOut_link" style="display:none"
                                    onclick=logOut()>Logout</a>
                                <a href="auth.php" class="nav-item nav-link active" id="login_details"
                    ...
                    <div class="col-lg-4 col-md-6 mx-auto wow fadeInUp" data-wow-delay="0.1s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="p-4">
                                ...
                                <!-- Form -->
                                <div class="form my-4">
                                    <form name="auth_form" class="d-flex flex-column justify-content-between gap-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="forgot_password.php" class=" text-primary text-end my-3"
                                                id="forgot_pswrd">Forgot Password?
                                                </p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <button class="btn btn-sm mx-auto btn-primary rounded py-2 px-4"
                                                type="submit">Login</buttona>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <p class="text-body text-center mb-3">Don't have an account
...
<!-- Footer End -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.forms["auth_form"].addEventListener("submit", function (e) {
                ...
                if (email != '' && password != '') {
                    ...
                    xhr.onreadystatechange = function () {
                        if (xhr.readyState === 4 && xhr.status === 200) {
                            ...
                            // Check if the login was successful (you might need to adjust this condition based on your response)
                            if (data.hasOwnProperty("error") && data.error === "Invalid credentials") {
                    ...
                    xhr.open("POST", "auth_pros.php", true);
