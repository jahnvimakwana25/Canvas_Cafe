...
// Fetch only three menu items for the homepage section (single row)
$sql_top_items = "SELECT id, item_name, item_price, item_main_image, item_captions FROM items ORDER BY id DESC LIMIT 3";
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-4">
                    <?php if($result_top_items && $result_top_items->num_rows > 0): ?>
                        <?php $delay = 1; while($row = $result_top_items->fetch_assoc()): ?>
                            <?php 
                                $item_image = isset($row['item_main_image']) ? BASE_URL . $row['item_main_image'] : 'img/room-1.jpg';
                                $item_name = $row['item_name'];
                                $item_price = (float)$row['item_price'];
                                $item_caption = $row['item_captions'];
                            ?>
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.<?php echo $delay; ?>s">
                                <div class="room-item shadow rounded overflow-hidden">
                                    <div class="position-relative">
                                        <img class="img-fluid" src="<?php echo $item_image; ?>" alt="<?php echo htmlspecialchars($item_name); ?>" style="width:100%;height:220px;object-fit:cover;">
                                        <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">₹<?php echo number_format($item_price, 2); ?></small>
                                    </div>
                                    <div class="p-4 mt-2">
                                        <div class="d-flex justify-content-between mb-3">
                                            <h5 class="mb-0"><?php echo htmlspecialchars($item_name); ?></h5>
                                            <div class="ps-2">
                                        ...
                                        <p class="text-body mb-3"><?php echo htmlspecialchars($item_caption); ?></p>
