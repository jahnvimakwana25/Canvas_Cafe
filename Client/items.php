        ...
        <div class="container-xxl py-5 mb-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">
                        Explore Our <span class="text-primary text-uppercase">Items</span>
                    </h1>
                </div>              
                <div class="row g-4">
                    <!-- Data store  -->
                    ...
                    if ($result_items->num_rows > 0) {
                        while ($row = $result_items->fetch_assoc()) {
                            ...
                            $item_main_image = BASE_URL . $row["item_main_image"];
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="room-item shadow rounded overflow-hidden">
                                    <div class="position-relative">
                                        <img class="img-fluid-item" src="<?php echo $item_main_image; ?>"
                                    ...
                                    <div class="p-4 mt-2">
                                      ...
                                      <div class="d-flex justify-content-between">
                                        <a class="btn btn-sm btn-primary rounded py-2 px-4" href="view_details.php?id=<?php echo $id; ?>">View Detail</a>

                                  <form action="booking_order.php" method="post" style="display:inline;">
    <input type="hidden" name="item_id" value="<?php echo $row['id']; ?>">
    <input type="hidden" name="quantity" value="1">
    <button type="submit" class="btn btn-sm btn-dark rounded py-2 px-4">Order Now</button>
</form>
